...
export const counterSlice = createSlice({
  ...
  reducers: {
    ...
    addNbreTransactions: (state, action) => {
      state.nbreTransactions = action.payload.nbreTransactions
    }
  }
})
...
export const { increment, decrement, incrementByAmount, addProduct, 
  addProducts, addProductsOrder, clearProductsOrder, pushData, addNbreTransactions } = counterSlice.actions
